...
class MultipleDomainDataset:
    # N_STEPS = 101           # Default, subclasses may override
...
class RotatedMNIST(MultipleEnvironmentMNIST):
    ...
    def rotate_dataset(self, images, labels, angle):
        rotation = transforms.Compose([
            ...
            # transforms.Lambda(lambda x: rotate(x, angle, fill=(0,), interpolation=torchvision.transforms.InterpolationMode.BILINEAR)),
...
class Fundus(MultipleEnvironmentImageFolder):
    CHECKPOINT_FREQ = 300
    ENVIRONMENTS = ["APTOS", "DEEPDR", "IDRID", 'RLDR']
    def __init__(self, root, test_envs, hparams):
        self.dir = os.path.join(root, "fundus/")
        super().__init__(self.dir, test_envs, hparams['data_augmentation'], hparams)
...
class WILDSCamelyon(WILDSDataset):
    N_STEPS = 2001           # Default, subclasses may override
